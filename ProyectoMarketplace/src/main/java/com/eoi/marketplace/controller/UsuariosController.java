package com.eoi.marketplace.controller;
...
import com.eoi.marketplace.dto.UsuarioDto;
import com.eoi.marketplace.service.UsuarioService;
...
public class UsuariosController {
	...
	@PostMapping(value = "/{nombre}/{password}")
